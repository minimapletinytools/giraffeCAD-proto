"""
Launcher macro for basic joints test - automatically reloads all modules.

This is a thin wrapper that reloads the actual test script, so you can make
changes to test_basic_joints.py and re-run this macro without restarting FreeCAD.
"""
...
print("="*70)
print("GiraffeCAD FreeCAD - Basic Joints Test Launcher")
print("="*70)
...
modules_to_reload = [
    ...
    'test_basic_joints'  # Reload the test script itself
]
...
import test_basic_joints
importlib.reload(test_basic_joints)
test_basic_joints.main()
