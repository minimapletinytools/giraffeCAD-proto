...
# TODO this function kinda sucks... awkward to measure to use, yo uneed to measure_face(timber1).mark_onto_centerline().distance or osmething crap like that to set lateral_offset_from_centerline_timber1 :(
