...
class TestTimber:
    ...
    def test_get_position_on_centerline_from_bottom_global(self):
        ...
        pos_bottom = timber.get_position_on_centerline_from_bottom_global(Rational(0))
        assert pos_bottom[0] == 1
        assert pos_bottom[1] == 2
        assert pos_bottom[2] == 3
        
        # Test position at 3.0 from bottom
        pos_3 = timber.get_position_on_centerline_from_bottom_global(Rational(3))
        assert pos_3[0] == 1
        assert pos_3[1] == 2
        assert pos_3[2] == 6  # 3.0 + 3.0
        
        # Test position at top (10)
        pos_top = timber.get_position_on_centerline_from_bottom_global(Rational(10))
        assert pos_top[0] == 1
        assert pos_top[1] == 2
    ...
    def test_get_position_on_centerline_from_top_global(self):
        ...
        pos_top = timber.get_position_on_centerline_from_top_global(Rational(0))
        assert pos_top[0] == 1
        assert pos_top[1] == 2
        assert pos_top[2] == 13  # 3.0 + 10.0
        
        # Test position at 3.0 from top (= 7.0 from bottom)
        pos_3 = timber.get_position_on_centerline_from_top_global(Rational(3))
        assert pos_3[0] == 1
        assert pos_3[1] == 2
        assert pos_3[2] == 10  # 3.0 + 7.0
        
        # Test at bottom (10 from top = 0 from bottom)
        pos_bottom = timber.get_position_on_centerline_from_top_global(Rational(10))
        assert pos_bottom[0] == 1
        assert pos_bottom[1] == 2
