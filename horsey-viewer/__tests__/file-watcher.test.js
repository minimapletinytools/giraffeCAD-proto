...
describe('FileWatcher', () => {
  ...
  describe('start()', () => {
    ...
    test('should create library watcher when project root exists with code_goes_here', () => {
      const fs = require('fs');
      ...
      expect(libraryWatcherCall[0].pattern).toContain('code_goes_here/**/*.py');
    });

    test('should not create library watcher when code_goes_here does not exist', () => {
      const fs = require('fs');
  ...
  describe('hasLocalCodeGoesHere()', () => {
    test('should return true when code_goes_here exists under projectRoot', () => {
      const fs = require('fs');
      jest.spyOn(fs, 'existsSync').mockReturnValue(true);
    ...
    test('should return false when code_goes_here does not exist', () => {
      const fs = require('fs');
      jest.spyOn(fs, 'existsSync').mockReturnValue(false);
