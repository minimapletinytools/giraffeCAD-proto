...
If you want to maintain face alignment, use `join_perpendicular_on_face_parallel_timbers` which will ensure all created timbers are joined. The joining timber will be perpendicular and face aligned with the input timbers or it will error if not possible.
