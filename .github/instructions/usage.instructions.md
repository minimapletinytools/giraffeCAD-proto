...
# GiraffeCAD Usage Rules


> These rules apply when writing timber frame designs using the GiraffeCAD API.
> The full standalone version of these rules (suitable for copying into your own project) is in `AGENT_INSTRUCTIONS.md` at the repo root.

<!-- The content below is kept in sync with AGENT_INSTRUCTIONS.md. If you edit one, edit the other. -->

TODO REWRITE ME THIS ONE WAS WRITTEN BY AI
